 ...
 $Email = $_POST['email'];
 $busca_query = mysql_query("SELECT usu_email, usu_senha, ava_id FROM usu_avaliador WHERE usu_email = '$Email' ")or die(mysql_error());
  if (mysql_num_rows($busca_query) == 0) { //Se nao achar nada, lança essa mensagem
    echo file_get_contents('esquecisenhaavaliador.html');
